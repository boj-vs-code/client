...
suite("BOJ API TEST at api/boj/managers/problem", () => {
  suite("ProblemManager#recent", () => {
    ...
    test("after getting problem, recent will return the problem instance", () => {
      ProblemManager.getInstance().getProblem(1000);
  ...
  suite("ProblemManager#getProblem", () => {
    test("(1000)", () => {
      ...
      const actual = <Problem>ProblemManager.getInstance().getProblem(1000);
